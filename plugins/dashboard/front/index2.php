                            ...
                            <div class="sidebar-holder">
                                ...
                                <ul class="nav nav-list">
                                    ...
                                    <a class='dropdown' onClick='return false;' href='#' data-original-title='Relatórios'>
                                       ...
                                       <li class=' '>
                                            <a href="./reports/rel_categorias.php" data-original-title=' Categorias' target="_blank">
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo _n('Category','Categories',2); ?> </span>
                                            </a>
                                        </li>
                                       <li class=' '>
                                            <a href="./reports/rel_slas.php" data-original-title=' SLAs' target="_blank">
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('SLAs'); ?> </span>
                                            </a>
                                        </li>
                                         <li class=' '>
                                        ...
                                        <li class=' '>
                                            <a href="./reports/rel_projects.php" data-original-title=' Projetos' target="_blank">
                                                <i class="fa fa-angle-right"></i>
...
<!-- .content -->
<div class="content animated fadeInBig corpo" style="margin-top: 60px; margin-left:220px;">
    <!-- main-content -->
