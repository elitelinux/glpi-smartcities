    ...
    <div class="navbar yamm navbar-default nav-delighted" id="menuHeader"> 
        ...
        <div id="navbar-collapse-1" class="navbar-collapse collapse">
          ...
          <li class="nav-link dropdown"><span onclick="location.href=('index.php')"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-icon"><i class='fa fa-dashboard'></i>&nbsp;Dashboard</a></span></li>
           ...
           <!-- Classic dropdown -->
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1"><i class='fa fa-edit'></i>&nbsp;<?php echo __('Tickets','dashboard');?>&nbsp;<b class="caret"></b></span></a>
                    ...
                    <div class="row">
                      <ul class="col-sm-2 list-unstyled menu1" style="width:180px;">
                       <li>
                        ...
                        <li><a href="./reports/rel_tecnicos.php?con=1" target="iframe1" > <?php echo __('Technician')."s"; ?> </a></li>
                        <li><a href="./reports/rel_grupos.php?con=1" target="iframe1" > <?php echo _n('Group','Groups',2); ?> </a></li>
                        <li><a href="./reports/rel_categorias.php?con=1" target="iframe1" > <?php echo _n('Category','Categories',2)."s"; ?> </a></li>
                        <li><a href="./reports/rel_slas.php?con=1" target="iframe1" > <?php echo __('SLAs'); ?> </a></li>                         
            ...
            <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle" style="color:#fff;"><span class="text-nav1"><i class='fa fa-bar-chart-o'></i>&nbsp;<?php echo __('Charts','dashboard');?>&nbsp;<b class="caret"></b></span></a>
                  ...
                  <div class="yamm-content" style="width:400px;">
                    <div class="row">
                      <ul class="col-sm-2 list-unstyled menu1" style="width:180px;">
                        ...
                        <li><a href="./graficos/entidades.php" target="iframe1" > <?php echo __('Entity','dashboard'); ?> </a></li>
                        <li><a href="./graficos/categorias.php" target="iframe1" > <?php echo __('Category'); ?> </a></li>
                        <li><a href="./graficos/grupos.php" target="iframe1" > <?php echo __('Group','dashboard'); ?> </a></li>
                        <li><a href="./graficos/local.php" target="iframe1" > <?php echo __('Location'); ?> </a></li>
