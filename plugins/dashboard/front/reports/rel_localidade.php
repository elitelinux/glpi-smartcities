...
while($row = $DB->fetch_assoc($result_cham)){
  ...
  ".$entidade."	";
	...
	<td style='vertical-align:middle;' align='left' ><img src=".$CFG_GLPI['root_doc']."/pics/".$status1.".png title='".Ticket::getStatus($row['status'])."' style=' cursor: pointer; cursor: hand;'/>&nbsp; ".Ticket::getStatus($row['status'])."  </td>
