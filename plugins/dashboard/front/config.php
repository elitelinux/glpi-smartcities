		...
		echo "</td>
			 ...
			 echo "<table border='0' style='width: 510px; margin-left: auto; margin-right: auto; margin-bottom: 5px; margin-top:20px;'>									
					...
					<tr style='text-align:center;'>				
						...
						<td>&nbsp;&nbsp;</td>		
						<td><button class='btn btn-primary btn-sm' type='button' id='skin-material' name='glpi_skin' value=\"Material\" onclick='location.href=\"config.php?theme=material.css\"'> Material </button></td>
						<td>&nbsp;&nbsp;</td>				
