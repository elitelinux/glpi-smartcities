...
//user image and name
$photo_url = "http://10.20.0.223/fotos_rh/". $_SESSION["glpiname"] .".jpg";
...
<head>
    ...
    <?php echo '<meta http-equiv="refresh" content= "120"/>'; ?>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
						...
						<div class="row" style="margin-left: 3%;">
							<!-- COLUMN 1 -->															
								  <div class="col-sm-3 col-md-3 stat">
									 <div class="dashbox shad panel panel-default">
	...
	<div class="row-fluid" style="margin-top: 75px;">
		...
		<div class="col-sm-6 col-md-6 knob-wrapper">
			<div id="graf7" style="height:320px;"> 
				<?php
					include ("graficos/inc/index/grafbar_setedias.inc.php");
				?> 	 				              
			</div> 
  		</div>  
            ...
            <!-- /widget-header -->
              ...
              <table id="logged_users" class="table table-hover table-bordered table-condensed" >                         
				...
				while($row_name = $DB->fetch_assoc($result_name)) 
	  			   {
						echo "<tr>
							  <td style='text-align: left;'><img src='http://10.20.0.223/fotos_rh/". $row_name['glpiname'] .".jpg' width=30px height=40px> &nbsp;&nbsp;&nbsp;
