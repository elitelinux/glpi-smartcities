...
<!-- .content -->
<div class="content animated fadeInBig" style="margin-top: 60px;">
    <!-- main-content -->
            ...
            <!-- /widget-header -->
              ...
              <table id="logged_users" class="table table-hover table-bordered table-condensed" >                         
				...
				while($row_name = $DB->fetch_assoc($result_name)) 
	  			   {
						echo "<tr>
									<td style='text-align: left;'><img src=".$photo_url." alt='user' width='30px' height='35px' />&nbsp; &nbsp;<a href=../../../front/user.form.php?id=".$row_name['uid']." target=_blank style='color: #526273;'>
