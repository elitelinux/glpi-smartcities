 ...
 */
class PluginTwinsTwins extends CommonDBTM
{
    /**
     ...
     */
    function getName($with_comment = 0){return "twins";} 
...
//=========================== Méthodes générales =============================//
    ...
    function getAbsolutePathForm()
        {return str_replace("front/twins.form.php", "", $_SERVER['SCRIPT_FILENAME']);}
