                            ...
                            <tr>
                                ...
                                {else}
                                    <td class="tab_td_AD1">
                                        ...
                                        {/if}
                                        {if $k=="suffix"}
                                            <label rel=tooltip title="Suffix du domaine, <br> ex: @ugr3.lan">{$k}</label>
                                        {/if}
                                        {if $k=="login"}
                                            <label rel=tooltip title="Login d'un administrateur <br> ou opérateur de compte <br> du domaine ">{$k}</label>
                                        {/if}
                                        {if $k=="passwd"}
                                            <label rel=tooltip title="Mot de passe de l'administrateur <br> ou opérateur de compte <br> du domaine ">{$k}</label>
                                        {/if}
                                        {if $k=="groupe"}
                                            <label rel=tooltip title="Nom du groupe contenant <br> les groupes pour ordinateur <br> pouvant être peuplés ">{$k}</label>
                                        {/if}
                                    </td>
                                    <td>
                                        {if $k=="passwd"}
...
<script type="text/javascript">  
    ...
    function testerAd(ad)
    {
        ...
        xmlhttp.open("POST","{/literal}{$httpPath|cat:"plugins/twins/ajax/config.ajax.php"}{literal}",true);
