...
<script type="text/javascript">  
    ...
    function impression()
    {
        var DATA = 'action=impression&idOrdinateur={/literal}{$idOrdinateur}{literal}';  
    ...
    {
        if(action == 'on'){    
            var DATA = 'action=on&idOrdinateur={/literal}{$idOrdinateur}{literal}';        
            if (window.XMLHttpRequest){xmlhttp=new XMLHttpRequest();}
            else{xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");}
        ...
        if(action == 'validation'){
            ...
            var DATA = 'action=validation&idOrdinateur='+selectComputer;
            if (window.XMLHttpRequest){xmlhttp=new XMLHttpRequest();}
            else{xmlhttp=new ActiveXObject("Microsoft.XMLHTTP");}
        ...
        if(action == 'cloner'){
            ...
            var DATA = 'action=cloner&idOrdinateur={/literal}{$idOrdinateur}{literal}&idCloner='+selectComputer; 
    ...
    {
        var DATA = "action="+action+"&groupe="+groupe+"&groupeModif="+groupeModif+"&id="+id;  
    ...
    function log()
    {
        window.open ("{/literal}{$httpPath|cat:"plugins/twins/popup/twins.popup.php?id=$idOrdinateur"}{literal}",
