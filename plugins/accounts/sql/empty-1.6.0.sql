...
DROP TABLE IF EXISTS `glpi_plugin_accounts_hashs`;
CREATE TABLE `glpi_plugin_accounts_hashs` (
   	`id` int(11) NOT NULL auto_increment,
   	`hash` varchar(255) collate utf8_unicode_ci default NULL,
   	PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `glpi_plugin_accounts_hashs` ( `id` , `hash` ) VALUES (1, '');

DROP TABLE IF EXISTS `glpi_plugin_accounts_aeskeys`;
CREATE TABLE `glpi_plugin_accounts_aeskeys` (
   	`id` int(11) NOT NULL auto_increment,
   	`aeskey` varchar(255) collate utf8_unicode_ci default NULL,
   	PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `glpi_notificationtemplates` VALUES(NULL, 'New Accounts', 'PluginAccountsAccount', '2010-02-17 22:36:46','');
INSERT INTO `glpi_notificationtemplates` VALUES(NULL, 'Alert Accounts', 'PluginAccountsAccount', '2010-02-23 11:37:46','');
