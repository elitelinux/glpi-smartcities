...
xgettext *.php */*.php --copyright-holder='Racks Development Team' --package-name='GLPI - Racks plugin' --package-version='1.4.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
