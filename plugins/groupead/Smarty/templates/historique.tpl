...
<div style="height: 200px; overflow-y: scroll; overflow-x: hidden" name="Historique">
    <table class='tab_cadre' style="width: 600px;">
        <TR><TH colspan="4">Historique du peuplement</TH></TR>
        <TR bgcolor="#FFF4DF">
            <TD width="25px">Technicien</TD>
            <TD width="50px">Date</TD>
            <TD width="25px">Action</TD>
            <TD width="490px">Groupe</TD>
        </TR> 
        {$ligne = "grey"}
        {foreach from=$historique item=ligne_historique}
            ...
            <TR bgcolor="{$ligne}">
                ...
                <TD width="25px">{$ligne_historique.action}</TD>
                <TD width="490px">{$ligne_historique.groupe}</TD>
            </TR>
        {/foreach}
    </table>    
</div>