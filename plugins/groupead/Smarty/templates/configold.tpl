...
*}
<body>{literal}
    <link rel="stylesheet" type="text/css" href="{/literal}{$httpPath|cat:"plugins/groupead/css/config.css"}{literal}" media="all"/>
</head>{/literal}
                        ...
                        {foreach from=$AD key=k item=valueAD}
                            <tr>
                                ...
                                {else}
                                    ...
                                    <td width="30px"><button id="btn-modifAD" onclick="changeAD('{$k|cat:$val}')">
