...
//============================================================================//
//==            !!!!!! METHODES AJOUTEES POUR LE PLUGIN !!!!!!              ==//
//============================================================================//
   
   /**
    * !!!! Méthode ajouter !!!!
    * Désactive un ordinateur
    * 
    * @param string $dn le dn de l'ordinateur
    * @return bool
    */
    public function desactiverComputer($dn)
        {
        $controlOptions = array("ACCOUNTDISABLE", "PASSWD_NOTREQD", "WORKSTATION_TRUST_ACCOUNT");
        $mod["userAccountControl"][0] = $this->accountControl($controlOptions);
