...
<FORM METHOD=POST ACTION={$post_Form_Reforme}>
    <table class='tab_cadre_fixe'>
        ...
        <tr>
            ...
            <td align="left"><input type="text" class="form_Fond_Gris" size='15' name="domain" value="{$info.domain}" readonly/> <label>:Domaine</label> </td>
        </tr>
        <tr>
            {if $info.des_bien != ""}
            <td align="right"><label>Modèle du bien:</label> 
