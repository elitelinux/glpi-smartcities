		...
		collapsibleContain	
			.bind('collapse', function(event){
				if( !event.isDefaultPrevented() ){
					...
					collapsibleHeading.find('.ui-icon').removeClass('ui-icon-arrow-d').addClass('ui-icon-arrow-l');	
			...
			.bind('expand', function(event){
				if( !event.isDefaultPrevented() ){
					...
					collapsibleHeading.find('.ui-icon').removeClass('ui-icon-arrow-l').addClass('ui-icon-arrow-d');	
