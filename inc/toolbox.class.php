<?php
/*
 * @version $Id: toolbox.class.php 23188 2014-10-13 21:54:09Z moyo $
 -------------------------------------------------------------------------
...
//                echo $decoded_where;exit();
   ...
   **/
   static function showMailServerConfig($value) {
      ...
      echo "<td><input size='30' type='text' name='mail_server' class='form-control' value=\"" .$tab['address']. "\">";
      echo "</td></tr>\n";
      ...
      echo "<td><input size='30' type='text' name='server_mailbox' class='form-control' value=\"" . $tab['mailbox'] . "\" >";
      echo "</td></tr>\n";

      //TRANS: for mail connection system
      echo "<tr class='tab_bg_1'><td>" . __('Port (optional)') . "</td>";
      echo "<td><input size='10' type='text' name='server_port' class='form-control' value='".$tab['port']."'></td></tr>\n";
      if (empty($value)) {
         $value = "&nbsp;";
      }
      //TRANS: for mail connection system
